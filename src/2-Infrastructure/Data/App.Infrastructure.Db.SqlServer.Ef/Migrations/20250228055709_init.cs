    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_Requests_RequestId1",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, 1000m, "4a0539d5-4327-49b3-a44c-73f88748625e", new DateTime(2025, 2, 28, 5, 57, 8, 581, DateTimeKind.Utc).AddTicks(6143), "admin@gmail.com", false, "Admin", false, true, "User", false, null, "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "AQAAAAIAAYagAAAAENkab+AKAcEsKbc8ec5rCQq+0OjcCs4PD6hBiDi1oqHJBx9s4L7xOiZBl2sIW2ddng==", null, false, "images\\User\\Admin\\admin.png", 3, "192824e7-3868-41ea-9322-5bc5ffa55c2f", false, "admin@gmail.com" },
                    { 2, 0, 500m, "27fef48f-bf7d-4d15-9e83-2a944045bf58", new DateTime(2025, 2, 28, 5, 57, 8, 641, DateTimeKind.Utc).AddTicks(1939), "ali@gmail.com", false, "علی", false, true, "عباسی", false, null, "ALI@GMAIL.COM", "ALI@GMAIL.COM", "AQAAAAIAAYagAAAAEIoJ9Y1haGg1ATrA15FrNJmMVcK63dvyZtRvcIv63UQRvnrw4cXuxq1MrFbDuY3YGg==", null, false, "images\\User\\Customer\\ali.jpg", 1, "35c61bd4-1ae0-422c-91b9-b3f93249da8d", false, "ali@gmail.com" },
                    { 3, 0, 650m, "b80c8df1-cb8a-4029-9c81-e710e4e1a6be", new DateTime(2025, 2, 28, 5, 57, 8, 698, DateTimeKind.Utc).AddTicks(2559), "sina47@gmail.com", false, "سینا", false, true, "مرادی", false, null, "SINA47@GMAIL.COM", "SINA47@GMAIL.COM", "AQAAAAIAAYagAAAAEN9NrYuI/u+9Eycpc1rVdiJq62+9M5jMufoJvrqoXE6WnlssHTvT4FNNLskcNfGmZA==", null, false, "images\\User\\Customer\\sina.png", 1, "6b2c9c2e-9fe8-4fad-8c32-ca2bd85b931b", false, "sina47@gmail.com" },
                    { 4, 0, 750m, "8c4f3451-aa9d-495e-86d9-e034a3bdf30c", new DateTime(2025, 2, 28, 5, 57, 8, 754, DateTimeKind.Utc).AddTicks(8096), "shahin@gmail.com", false, "شاهین", false, true, "حسنی", false, null, "SHAHIN@GMAIL.COM", "SHAHIN@GMAIL.COM", "AQAAAAIAAYagAAAAEIwTKzITbObVjVJKZrUuvHPeESkOoGw4FIXbnsUrAC12FdQvPiN/Y3efUsMo4p0ypw==", null, false, "images\\User\\Expert\\shahin.png", 2, "b739b8dd-70cf-4329-a483-10cdc1623b32", false, "shahin@gmail.com" },
                    { 5, 0, 100m, "914c7dd0-dbda-434b-8c02-844acc9822ce", new DateTime(2025, 2, 28, 5, 57, 8, 811, DateTimeKind.Utc).AddTicks(4726), "karimi@gmail.com", false, "فاطمه", false, true, "کریمی", false, null, "KARIMI@GMAIL.COM", "KARIMI@GMAIL.COM", "AQAAAAIAAYagAAAAENFg9qIB2kKt2qwWUzPObRqe05JPv5rUG7+p+P66ynWVySXchP/r0GPkqbbHxdP6aA==", null, false, "images\\User\\Expert\\fatemeh.png", 2, "64e3a09d-b3fd-47f5-b8e0-572b2a43d611", false, "karimi@gmail.com" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Requests",
                columns: new[] { "Id", "CreatedAt", "CustomerId", "Deadline", "Description", "ExecutionDate", "IsEnabled", "Status", "SubHomeServiceId" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 2, 28, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(1831), 1, new DateTime(2025, 3, 5, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(1824), "درخواست بنایی ساختمان", new DateTime(2025, 3, 3, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(1830), true, 0, 10 },
                    { 2, new DateTime(2025, 2, 28, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(1834), 1, new DateTime(2025, 3, 7, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(1833), "درخواست کاغذ دیواری", new DateTime(2025, 3, 5, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(1833), true, 0, 11 },
                    { 3, new DateTime(2025, 2, 28, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(1836), 2, new DateTime(2025, 3, 10, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(1835), "درخواست سنگ کاری", new DateTime(2025, 3, 8, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(1836), true, 0, 12 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Proposals",
                columns: new[] { "Id", "CreatedAt", "Description", "ExecutionDate", "ExpertId", "IsEnabled", "Price", "RequestId", "ResponseTime", "SkillId", "Status" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 2, 28, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(5657), "پیشنهاد انجام خدمات برای درخواست بنایی", new DateTime(2025, 3, 5, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(5655), 1, true, 450000m, 1, new DateTime(2025, 3, 1, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(5657), 1, 0 },
                    { 2, new DateTime(2025, 2, 28, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(5660), "پیشنهاد انجام خدمات برای درخواست کاغذ دیواری", new DateTime(2025, 3, 3, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(5659), 1, true, 600000m, 2, new DateTime(2025, 3, 1, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(5660), 2, 0 }
                });

            migrationBuilder.InsertData(
                table: "Proposals",
                columns: new[] { "Id", "CreatedAt", "Description", "ExecutionDate", "ExpertId", "Price", "RequestId", "ResponseTime", "SkillId", "Status" },
                values: new object[] { 3, new DateTime(2025, 2, 28, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(5663), "پیشنهاد انجام خدمات برای درخواست سنگ کاری", new DateTime(2025, 3, 7, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(5662), 2, 780000m, 3, new DateTime(2025, 3, 2, 5, 57, 8, 579, DateTimeKind.Utc).AddTicks(5662), 3, 0 });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "CreatedAt", "CustomerId", "ExpertId", "FinalPrice", "IsActive", "PaymentStatus", "ProposalId", "RequestId", "RequestId1" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 2, 28, 5, 57, 8, 580, DateTimeKind.Utc).AddTicks(5477), 1, 1, 450m, true, 0, 1, 1, null },
                    { 2, new DateTime(2025, 2, 28, 5, 57, 8, 580, DateTimeKind.Utc).AddTicks(5481), 1, 1, 600m, true, 0, 2, 2, null },
                    { 3, new DateTime(2025, 2, 28, 5, 57, 8, 580, DateTimeKind.Utc).AddTicks(5483), 2, 2, 780m, true, 0, 3, 3, null }
                });

            migrationBuilder.InsertData(
                table: "Reviews",
                columns: new[] { "Id", "Comment", "CreatedAt", "CustomerId", "ExpertId", "IsApproved", "OrderId", "Rating" },
                values: new object[,]
                {
                    { 1, "خیلی عالی بود سرموقع انجام شد", new DateTime(2025, 2, 28, 5, 57, 8, 580, DateTimeKind.Utc).AddTicks(9638), 1, 1, false, 1, 5 },
                    { 2, "سرویس خوبی انجام دادن فقط یکم تو تحویل سرویس تاخیر داشتن", new DateTime(2025, 2, 28, 5, 57, 8, 580, DateTimeKind.Utc).AddTicks(9640), 1, 1, false, 2, 4 },
                    { 3, "فوق العاده بود همه چی", new DateTime(2025, 2, 28, 5, 57, 8, 580, DateTimeKind.Utc).AddTicks(9642), 2, 2, false, 3, 5 }
                });
